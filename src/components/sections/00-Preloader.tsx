  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        onClick={handleOpen}
        className="fixed md:absolute inset-0 z-[9999] md:z-50 flex flex-col items-center justify-center overflow-hidden bg-ivory cursor-pointer select-none w-full h-full min-h-screen md:min-h-full"
      >
